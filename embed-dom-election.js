...
if (document.location.hostname == "localhost") {
  ...
  var baseurl = "https://static.code4sa.org/scatter_2016_lge/";
}

var container = document.getElementById('code4sa-election-index');

var pymParentScript = document.createElement( 'script' );
pymParentScript.type = 'text/javascript';
pymParentScript.text = "var pymParent = new pym.Parent('code4sa-election-index', '"
  + baseurl + "index.html', {});";
